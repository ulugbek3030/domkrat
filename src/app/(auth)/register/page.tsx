      ...
      <CardContent className="pt-6">
        ...
        <div className="space-y-3 mb-4">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-lg border border-gray-300 bg-black px-4 py-2.5 text-sm font-medium text-white shadow-sm hover:bg-gray-900 transition-colors"
          >
            <AppleIcon />
            Продолжить с Apple
          </button>
